...
export const MAINTENANCE_COLUMNS =
  "id, owner_user_id, vehicle_id, performed_at, mileage, service_type, description, cost, currency, trust_label, source_type, document_id, created_at, updated_at, deleted_at";
